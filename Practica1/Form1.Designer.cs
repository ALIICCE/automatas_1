        ...
        private List<string> P_Reservadas = new List<string>
{
    ...
    "const", "volatile", "register", "goto",
    
    // Funciones estándar
    "printf", "scanf", "fgets", "fputs", "fprintf", "fscanf",
    "sprintf", "sscanf", "memcpy", "memset", "strlen", "strcmp",
    "strcpy", "strncpy", "strcat", "strncat", "malloc", "free",
    "calloc", "realloc", "abort", "atexit", "array",
    
    // Booleanos y valores lógicos
    "true", "false", "NULL",
    
    // Variables y manejo de punteros
    "auto", "register", "static", "volatile", "restrict"
};
